...
{        
    ...
    $.ajax({
        url : 'ServletSPTablas', 
        data : "opcion_MaeTablas="+id+"&hid_tabla_id="+x_id+"&slt_tabla_mae="+tablamae+"&slt_tabla_rel1="+rel1+"&slt_tabla_rel2="+rel2+"&txt_tabla_descripcion="+desc,
        type : 'POST',
        dataType : "html",
        success : function(data) {
            location.href="SL_Mantencion_Configuracion.jsp";
        }
    });
}
